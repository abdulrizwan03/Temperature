...
function gt(num){
    switch(num){
        case 1:
            window.open("https://www.facebook.com/rizwan.mohammedabdul.5","_blank");
            break;
        case 2:
            window.open("https://twitter.com/Riz203","_blank");
            break;
        case 3:
            window.open("https://www.youtube.com/account","_blank");
            break;
        case 4:
            window.open("https://www.linkedin.com/in/mohammed-abdul-rizwan-3594b0287","_blank");
            break;
        case 5:
            window.open("https://github.com/abdulrizwan03","_blank");
            break;
